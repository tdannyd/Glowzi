...
export const metadata: Metadata = {
  ...
  description:
    "Glowzi specializes in personalized and rejuvenating skincare treatments, facials, and cutting-edge formulations.",
    generator: 'v0.dev'
}
    ...
    <html lang="en">
      <body className={`${playfair.variable} ${cormorant.variable} font-sans`}>
        ...
        <footer className="bg-[#f5eee3] py-12">
          <div className="container mx-auto px-4">
            <p className="text-sm text-gray-600 text-center">© 2025 Glowzi. All rights reserved.</p>
          </div>
        </footer>
      </body>
    </html>
